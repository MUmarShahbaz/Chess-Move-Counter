...
<body>
    <div class='review-container'>
        ...
        <div class='move-row'>
            ...
            <div class='move-count'>{moves.get("brilliant", 0)}</div>
        </div>
        <div class='move-row'>
            <div class='move-label'>
                <svg xmlns="http://www.w3.org/2000/svg" class="" width="24" height="24" viewBox="0 0 18 19">
            ...
            <div class='move-count'>{moves.get("great", 0)}</div>
        </div>
        <div class='move-row'>
            <div class='move-label'>
                <svg xmlns="http://www.w3.org/2000/svg" class="" width="24" height="24" viewBox="0 0 18 19">
            ...
            <div class='move-count'>{moves.get("best", 0)}</div>
        </div>
        <div class='move-row'>
            <div class='move-label'>
                <svg xmlns="http://www.w3.org/2000/svg" class="" width="24" height="24" viewBox="0 0 18 19">
                    <g id="excellent">
                        ...
                        <g class="icon-component-shadow" opacity="0.2">
                            ...
                            <path
                                d="M5.49,8.09H4.31a.5.5,0,0,0-.5.5v4.56a.5.5,0,0,0,.5.5H5.49a.5.5,0,0,0,.5-.5V8.59A.5.5,0,0,0,5.49,8.09Z">
                            </path>
                        </g>
                        <g>
                            <path class="icon-component" fill="#fff"
            ...
            <div class='move-count'>{moves.get("excellent", 0)}</div>
        </div>
        <div class='move-row'>
            <div class='move-label'>
                <svg xmlns="http://www.w3.org/2000/svg" class="" width="24" height="24" viewBox="0 0 18 19">
            ...
            <div class='move-count'>{moves.get("good", 0)}</div>
        </div>
        <div class='move-row'>
            <div class='move-label'>
                <svg xmlns="http://www.w3.org/2000/svg" class="" width="24" height="24" viewBox="0 0 18 19">
                    <g id="book">
                        ...
                        <g>
                            <path class="icon-component-shadow" opacity="0.3" isolation="isolate"
                            ...
                            <path class="icon-component" fill="#fff"
                                d="M8.45,5.4c-1-.75-2.51-1.09-4.83-1.09H3V13h.58a8.09,8.09,0,0,1,4.83,1.17Z"></path>
                            <path class="icon-component" fill="#fff"
                                d="M9.54,14.19A8.14,8.14,0,0,1,14.38,13H15V4.31h-.58c-2.31,0-3.81.34-4.84,1.09Z"></path>
                        </g>
                    </g>
                </svg>Book
            </div>
            <div class='move-count'>{moves.get("book", 0)}</div>
        </div>
        <div class='move-row'>
            <div class='move-label'>
                <svg xmlns="http://www.w3.org/2000/svg" class="" width="24" height="24" viewBox="0 0 18 19">
            ...
            <div class='move-count'>{moves.get("inaccuracy", 0)}</div>
        </div>
        <div class='move-row'>
            <div class='move-label'>
                <svg xmlns="http://www.w3.org/2000/svg" class="" width="24" height="24" viewBox="0 0 18 19">
            ...
            <div class='move-count'>{moves.get("mistake", 0)}</div>
        </div>
        <div class='move-row'>
            <div class='move-label'>
                <svg xmlns="http://www.w3.org/2000/svg" class="" width="24" height="24" viewBox="0 0 18 19">
                    ...
                    <g id="incorrect">
                        <path class="cls-4" d="M9,.5C4.03,.5,0,4.53,0,9.5s4.03,9,9,9,9-4.03,9-9S13.97,.5,9,.5Z"></path>
                        <path class="cls-2" d="M9,0C4.03,0,0,4.03,0,9s4.03,9,9,9,9-4.03,9-9S13.97,0,9,0Z"></path>
                        <g class="cls-3">
                            <path
            ...
            <div class='move-count'>{moves.get("miss", 0)}</div>
        </div>
        <div class='move-row'>
            <div class='move-label'>
                <svg xmlns="http://www.w3.org/2000/svg" class="" width="24" height="24" viewBox="0 0 18 19">
                    <g id="blunder">
                        ...
                        <g class="icon-component-shadow" opacity="0.2">
                            ...
                            <path
                                d="M6.79,12.65H4.91l-.12,0a.34.34,0,0,0-.18.29v1.82a.36.36,0,0,0,.08.23.23.23,0,0,0,.1.07l.12,0H6.79a.24.24,0,0,0,.12,0A.26.26,0,0,0,7,15a.36.36,0,0,0,.07-.1.28.28,0,0,0,0-.13V13a.27.27,0,0,0,0-.12.61.61,0,0,0-.07-.1A.32.32,0,0,0,6.79,12.65Z">
                            </path>
                            <path
